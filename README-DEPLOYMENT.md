...
## الخطوة 7: تسجيل الدخول للوحة التحكم

كلمة المرور الافتراضية للوصول إلى لوحة التحكم هي:
`admin123`

يمكنك تغيير هذه الكلمة من خلال تعديل الشرط الموجود في ملف `src/app/login/page.tsx`.
